...
CREATE TABLE `iuapd_allowances` (
  ...
  `NAME2` varchar(64) DEFAULT NULL COMMENT '员工姓名2',
  `NAME3` varchar(64) DEFAULT NULL COMMENT '员工姓名3',
  `NAME4` varchar(64) DEFAULT NULL COMMENT '员工姓名4',
  `NAME5` varchar(64) DEFAULT NULL COMMENT '员工姓名5',
  `NAME6` varchar(64) DEFAULT NULL COMMENT '员工姓名6',
...
CREATE TABLE `iuapd_emergency_contact` (
  ...
  `CONTACT_NAME2` varchar(32) DEFAULT NULL COMMENT '联系人姓名2',
  `CONTACT_NAME3` varchar(32) DEFAULT NULL COMMENT '联系人姓名3',
  `CONTACT_NAME4` varchar(32) DEFAULT NULL COMMENT '联系人姓名4',
  `CONTACT_NAME5` varchar(32) DEFAULT NULL COMMENT '联系人姓名5',
  `CONTACT_NAME6` varchar(32) DEFAULT NULL COMMENT '联系人姓名6',
...
CREATE TABLE `iuapd_grid_temp` (
  ...
  `MODEL_NAME2` varchar(255) DEFAULT NULL COMMENT '模型名称2',
  `MODEL_NAME3` varchar(255) DEFAULT NULL COMMENT '模型名称3',
  `MODEL_NAME4` varchar(255) DEFAULT NULL COMMENT '模型名称4',
  `MODEL_NAME5` varchar(255) DEFAULT NULL COMMENT '模型名称5',
  `MODEL_NAME6` varchar(255) DEFAULT NULL COMMENT '模型名称6',
...
CREATE TABLE `iuapd_purchase_order` (
  ...
  `ORDER_NAME2` varchar(64) DEFAULT NULL COMMENT '请购单名称2',
  `ORDER_NAME3` varchar(64) DEFAULT NULL COMMENT '请购单名称3',
  `ORDER_NAME4` varchar(64) DEFAULT NULL COMMENT '请购单名称4',
  `ORDER_NAME5` varchar(64) DEFAULT NULL COMMENT '请购单名称5',
  `ORDER_NAME6` varchar(64) DEFAULT NULL COMMENT '请购单名称6',
...
CREATE TABLE `iuapd_treelist_detail` (
  ...
  `NAME3` varchar(64) DEFAULT NULL COMMENT '姓名3',
  `NAME4` varchar(64) DEFAULT NULL COMMENT '姓名4',
  `NAME5` varchar(64) DEFAULT NULL COMMENT '姓名5',
  `NAME6` varchar(64) DEFAULT NULL COMMENT '姓名6',
